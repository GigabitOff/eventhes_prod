...
<main>
    ...
    <div class="container margin_60" style="padding-top: 16px; padding-bottom: 16px;">
        <div class="main_title">
            <h2>
                <span>{{ __('translate.Events') }} </span></h2>
                            ...
                            <a href="/{{$course->id}}">
                                ...
                                <div class="short_info">
                                    <i></i>{{$course->reserv}}<span
                                        class="price">@if ($course->amount == 0 || $course->discounte === null)
                                            FREE
                                        @else
                                            @php
                                                $discountedAmount = $course->amount - ($course->amount * $course->discounte / 100);
                                            @endphp
                                            <span style="color:#989fa6;font-size: smaller; text-decoration: line-through;">{{ number_format($course->amount, 2) }}$</span>
                                            {{ number_format($discountedAmount, 2) }}$
                                        @endif
</span>
                                </div>
        ...
        <div class="container margin_60">
            <div class="main_title">
                ...
                <div class="col-lg-6  other_tours" style="display: grid">
                    <ul>
                        @foreach($events as $event)
                            <li><a href="http://eventhes.com/tours?categories[]=city-sightseeing">
                                    ...
                                    {{$event->title}}
                                    <span class="other_tours_price ml-2">{{ (($event->amount == 0 || $event->discounte == null) ? 'FREE' : $event->amount . '$' . ($event->discounte . '%')) }}</span></a>
                            </li>
                        @endforeach
                    </ul>
                </div>
