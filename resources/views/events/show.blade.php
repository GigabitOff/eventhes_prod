            ...
            <nav class="col-9" id="your_menu_id">
                ...
                <ul id="top_tools" style="margin-top:-5px;">
                    <ul>
                        ...
                        <img src="{{ asset('storage/files/' . session('locale', config('app.locale')) . '.png') }}"
...
<main>
    <div  style="background-color: #e04f67; opacity: 0.8">
        <center>
        </center>
    </div>
            ...
            <div class="col-lg-8" id="single_tour_desc">
                <div id="single_tour_feat">
                    <ul>
                        ...
                        <li>
                            <a href="{{$event->is_links}}" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22"
        ...
        <h3>{{ __('translate.Portfolio') }}</h3>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <a href="" style="text-decoration: none;" class="btn_1 add_bottom_30" id="my-link"
                           data-toggle="modal"
