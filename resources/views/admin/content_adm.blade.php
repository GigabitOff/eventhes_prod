                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                @foreach ($eventOrderCounts as $eventTu)
                                    <tr>
                                        <td><a style="text-decoration: underline;" href="/admin/events/{{$eventTu['order_id'] }}/edit">{{ $eventTu['order_id'] }}</td>
                                        <td>{{ $eventTu['order_count'] }}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
