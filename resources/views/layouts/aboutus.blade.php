...
<div class="container margin_60" style="margin-top:50px;">
    <div class="main_title">
        <h2><span>{{ __('translate.About Us') }}</span></h2>
    </div>
    <div class="row">
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
            <div class="feature"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                ...
                <h3><span>{{ __('translate.+ 1000 Customers') }}</span></h3>
                <p>{{ __('translate.We are thrilled to announce that our family has grown by another one thousand! One thousand new customers have chosen us to meet their needs, and we are incredibly grateful for their trust. Your participation in our service means a lot to us, and we strive to provide you with only the highest standards of service. This milestone is a tremendous achievement for us - a testament to our commitment to quality and excellence. We are working to continue to evolve and improve our service so that you can enjoy it even more. Thank you for your faith in us and your ongoing support in our journey. We are proud to have you in our community.') }}</p>
            </div>
        </div>
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
            <div class="feature"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-node-plus" viewBox="0 0 16 16">
                ...
                <h3><span>{{ __('translate.+120 Events for time') }}</span></h3>
                <p>{{ __('translate.In addition, we\'re excited to share that we\'ve hosted 120 events during this time, providing valuable experiences and opportunities for our community to come together and connect. Thank you for your faith in us and your ongoing support in our journey. We are proud to have you in our community.') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeIn;">
            <div class="feature"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16">
                ...
                <h3><span>{{ __('translate.H24 Support') }}</span></h3>
                <p>{{ __('translate.Furthermore, we\'re delighted to offer our service in 10 languages, ensuring accessibility and inclusivity for our global community. Moreover, we provide round-the-clock support (H24 Support), ensuring that assistance is available whenever you need it. Thank you for your faith in us and your ongoing support in our journey. We are proud to have you in our community.') }}</p>
            </div>
        </div>
        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
            <div class="feature"><i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-translate" viewBox="0 0 16 16">
                ...
                <h3><span>{{ __('translate.10 Languages available') }}</span></h3>
                <p>{{ __('translate.Furthermore, we\'re delighted to offer our service in 10 languages, ensuring accessibility and inclusivity for our global community. Moreover, we provide round-the-clock support (H24 Support), ensuring that assistance is available whenever you need it. Thank you for your faith in us and your ongoing support in our journey. We are proud to have you in our community.') }}</p>
            </div>
        </div>
    </div>
